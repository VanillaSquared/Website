const variants = {
  ...
  patchnotes: "bg-accent/10 text-[var(--vsq-text-inverse)]",
  announcement: "bg-[var(--vsq-tag-announcement-bg)] text-[var(--vsq-text-inverse)]",
  other: "bg-[var(--vsq-tag-other-bg)] text-[var(--vsq-text-inverse)]",
