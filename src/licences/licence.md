...
This licence applies to the original source code, design, text, images, and
other material in the VanillaSquared Website repository at
...
“Private Use” means use only by you, in an environment under your control,
that does not make the Website Material or a running copy of the website
available to any other person. An access-controlled build or continuous
integration service may be used solely to compile or test the Website
Material, provided that it does not serve the website to any person.

“Contribution” means code, content, documentation, or another change that you
intentionally submit to the Licensor for possible inclusion in the official
VanillaSquared Website repository.
...
a. access and use the official website in the ordinary manner intended for
   its visitors;

b. clone or download the Website Material;

c. reproduce, modify, compile, and test the Website Material for Private Use;
   and
...
approved by the Licensor. This narrow permission does not permit independent
publication or distribution of the Website Material.

By intentionally submitting a Contribution, you represent that you have the
right to submit it and grant the Licensor a perpetual, worldwide,
non-exclusive, irrevocable, royalty-free licence to use, reproduce, modify,
adapt, publish, distribute, sublicense, host, and commercially exploit the
...
a. publish, republish, share, distribute, sell, sublicense, or otherwise make
   available any copy of the Website Material, a modified version, or a
   compiled build, except for a Contribution permitted by section 3;

b. deploy, host, mirror, or serve the Website Material, a modified version,
   or a compiled build on the Internet or any other network, whether access
   is public or restricted;

c. use the Website Material, a modified version, or a compiled build for
   commercial purposes, advertising, sponsorship, paid services, fundraising,
   revenue generation, or any other direct or indirect financial benefit;

d. claim or imply that you created the Website Material or the VanillaSquared
   website, or misrepresent your relationship with or endorsement by the
   Licensor. You may accurately identify your own Contribution; or
...
another licence remains available under that earlier licence; this licence
does not withdraw or restrict permissions already granted for those releases.
...
provision is held unenforceable, it will be limited or removed only to the
...
use the Website Material beyond rights that applicable law gives you without
permission.
