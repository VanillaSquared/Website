...
An unknown or unloaded recipe ID can remain in the tag, but [`vsq:randomize_recipes`](/docs/datapacks/loot-functions/randomize_recipes_loot_function) skips it when selecting loot.
